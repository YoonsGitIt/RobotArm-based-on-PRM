...
# p2a.printRobotarm(startPoint)
plt.text(startPoint[3,0]+2,startPoint[3,1]+2,'start',fontsize = 20)
plt.text(goalPoint[3,0]+2,goalPoint[3,1]+2,'goal',fontsize = 20)
# plt.pause(5)
...
for i in range(len(short_path)-1):
    ...
    # plt.clf
    # p2a.printRobotarm(child_point)
    # plt.pause(0.5)
    plt.plot([child_point[3,0],parent_point[3,0]],[child_point[3,1],parent_point[3,1]],color="red",linewidth=3)
    # p2a.printRobotarm(parent_point)

plt.yticks(fontsize=30)
plt.xticks(fontsize=30)
# p2a.printRobotarm(goalPoint)
plt.show()